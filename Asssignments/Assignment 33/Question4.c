/* Q4-a)four players are playing a tournament of chess with round robbin method (each player will play with every other player).
Each wins has 1 points,draw has 1 point and loose has 0 points.declare a score board two dimentional array to store the scores of 
the players agains each player.
Q4-b)define a function to update score_board after each match result.
Q4-c)define a function to display score_board.
Q4-d)define a function which returns the score of specific player.
Q4-C)define a function to find the winner of the tournament 
Q4-C)define a function to display rank of the students.
Q4-C)define a function to run a tournament,in which user has to enter result of each game and update score board using score board function
